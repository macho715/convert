# AGI TR MasterSuite (v3.1.0) — QuickStart

## Package contents
- **AGI_TR6_MasterSuite_READY_v3_1.xlsm** : Ready workbook (schedule+gantt prefilled).  
- **AGI_TR_MasterSuite_v3_1.bas** : VBA module (import into the workbook).  
- **build_agi_tr_mastersuite_v3_1.py** : Python builder (rebuild workbook).  
- **test_mastersuite_v3_1.py** : Python sanity tests.

## Immediate use (Excel)
1) Open **AGI_TR6_MasterSuite_READY_v3_1.xlsm**
2) Enable Editing + Enable Content (Macros)
3) Press **ALT+F11** (VBA editor) → **File → Import File...**
4) Import **AGI_TR_MasterSuite_v3_1.bas**
...
Rebuild workbook:
```bash
python build_agi_tr_mastersuite_v3_1.py --out AGI_TR6_MasterSuite_READY_v3_1.xlsx
```

Run sanity tests:
```bash
python test_mastersuite_v3_1.py AGI_TR6_MasterSuite_READY_v3_1.xlsx
```
