...
'
' Version: 3.1.0
' Date: 2026-01-07 (patched v3.1.0)
'===============================================================================
...
Private Function ReadDate(ByVal sheetName As String, ByVal addr As String, ByVal def As Date) As Date
    ...
    If IsDate(Sheets(sheetName).Range(addr).Value) Then
        ReadDate = CDate(Sheets(sheetName).Range(addr).Value)
    Else
        ReadDate = def
    End If
    Exit Function
...
Private Function ReadLong(ByVal sheetName As String, ByVal addr As String, ByVal def As Long) As Long
    On Error GoTo ErrH
    ReadLong = CLng(Nz(Sheets(sheetName).Range(addr).Value, def))
    Exit Function
ErrH:
    ReadLong = def
End Function
...
Private Function ReadDouble(ByVal sheetName As String, ByVal addr As String, ByVal def As Double) As Double
    On Error GoTo ErrH
    ReadDouble = CDbl(Nz(Sheets(sheetName).Range(addr).Value, def))
    Exit Function
ErrH:
    ReadDouble = def
End Function
