...
def create_gantt_with_vba():
    ...
    ws_sched["A3"] = "⚠️ Winter Shamal Risk Period: Jan 14-21, 2026 | Schedule Auto-Updates from Control_Panel"
    ...
    # Task definitions (기존과 동일한 구조, 수식 기반)
    ...
    tasks = [
        ...
        # Voyage 1
        ("V1", "2.0", "VOYAGE 1: TR1 Transport", "MILESTONE", "All", 3, 0, "✅ Good Weather Window"),
        ("LO-101", "2.1", "TR1 Load-out on LCT", "LOADOUT", "Mammoet", 3, "DUR_LO", "High tide required"),
        ("SF-102", "2.2", "TR1 Sea Fastening", "SEAFAST", "Mammoet", 4, "DUR_SF", "12-point lashing"),
        ("MWS-103", "2.3", "MWS + MPI + Final Check", "BUFFER", "Aries/Captain", 4, "DUR_MWS", "Marine Warranty Surveyor"),
        ("SAIL-104", "2.4", "V1 Sail-away: MZP→AGI", "SAIL", "LCT Bushra", 5, "DUR_SAIL", "✅ Good Weather Window"),
        ("ARR-105", "2.5", "AGI Arrival + TR1 RORO Unload", "AGI_UNLOAD", "Mammoet", 6, "DUR_UL", "AGI FWD Draft ≤ 2.70m"),
        ("STORE-106", "2.6", "TR1 Stored on AGI Laydown", "BUFFER", "Mammoet", 7, "DUR_BUF", "Awaiting pair TR2"),
        ("RET-107", "2.7", "V1 LCT Return: AGI→MZP", "RETURN", "LCT Bushra", 7, "DUR_RET", "Quick turnaround"),
        ("BUF-108", "2.99", "V1 Buffer / Equipment Reset", "BUFFER", "All", 8, "DUR_BUF", "Weather contingency"),
        
        # Voyage 2 + Jack-down 1 (Batch)
        ("V2", "3.0", "VOYAGE 2: TR2 Transport + JD-1", "MILESTONE", "All", 9, 0, "✅ Good Weather Window (before Shamal)"),
        ("LO-109", "3.1", "TR2 Load-out on LCT", "LOADOUT", "Mammoet", 9, "DUR_LO", "High tide required"),
        ("SF-110", "3.2", "TR2 Sea Fastening", "SEAFAST", "Mammoet", 10, "DUR_SF", "12-point lashing"),
        ("MWS-110A", "3.25", "MWS + MPI + Final Check", "BUFFER", "Aries/Captain", 10, "DUR_MWS", "Pre-sail verification"),
        ("SAIL-111", "3.3", "V2 Sail-away: MZP→AGI", "SAIL", "LCT Bushra", 10, "DUR_SAIL", "⚠️ Near Shamal start"),
        ("ARR-112", "3.4", "AGI Arrival + TR2 RORO Unload", "AGI_UNLOAD", "Mammoet", 11, "DUR_UL", "AGI FWD Draft ≤ 2.70m"),
        ("TRN-113", "3.5", "TR1 Transport to Bay-1", "TURNING", "Mammoet", 12, 1, "Steel bridge install"),
        ("TURN-114", "3.6", "TR1 Turning (90° rotation)", "TURNING", "Mammoet", 13, "DUR_TURN", "10t Forklift required"),
        ("TRN-116", "3.8", "TR2 Transport to Bay-2", "TURNING", "Mammoet", 17, 1, ""),
        ("TURN-117", "3.9", "TR2 Turning (90° rotation)", "TURNING", "Mammoet", 18, "DUR_TURN", ""),
        ("JD-120", "3.95", "★ JD-1 Jack-Down Batch (TR1+TR2)", "JACKDOWN", "Mammoet", 21, "DUR_JD", "MILESTONE: TR1+TR2 Complete (Batch)"),
        ("RET-119", "3.11", "V2 LCT Return: AGI→MZP", "RETURN", "LCT Bushra", 22, "DUR_RET", "Return after JD-1"),
        ("BUF-120", "3.99", "V2 Buffer / Shamal Recovery", "BUFFER", "All", 23, "DUR_BUF", "Post-Shamal weather check"),
        
        # Voyage 3
        ("V3", "4.0", "VOYAGE 3: TR3 Transport", "MILESTONE", "All", 24, 0, "✅ Post-Shamal Window"),
        ("LO-121", "4.1", "TR3 Load-out on LCT", "LOADOUT", "Mammoet", 24, "DUR_LO", ""),
        ("SF-122", "4.2", "TR3 Sea Fastening", "SEAFAST", "Mammoet", 25, "DUR_SF", ""),
        ("MWS-122A", "4.25", "MWS + MPI + Final Check", "BUFFER", "Aries/Captain", 25, "DUR_MWS", ""),
        ("SAIL-123", "4.3", "V3 Sail-away: MZP→AGI", "SAIL", "LCT Bushra", 25, "DUR_SAIL", "Good weather"),
        ("ARR-124", "4.4", "AGI Arrival + TR3 RORO Unload", "AGI_UNLOAD", "Mammoet", 26, "DUR_UL", ""),
        ("STORE-125", "4.5", "TR3 Stored on AGI Laydown", "BUFFER", "Mammoet", 27, "DUR_BUF", "Awaiting pair TR4"),
        ("RET-126", "4.6", "V3 LCT Return: AGI→MZP", "RETURN", "LCT Bushra", 28, "DUR_RET", ""),
        ("BUF-127", "4.99", "V3 Buffer", "BUFFER", "All", 29, "DUR_BUF", ""),
        
        # Voyage 4 + Jack-down 2 (Batch)
        ("V4", "5.0", "VOYAGE 4: TR4 Transport + JD-2", "MILESTONE", "All", 30, 0, ""),
        ("LO-128", "5.1", "TR4 Load-out on LCT", "LOADOUT", "Mammoet", 30, "DUR_LO", ""),
        ("SF-129", "5.2", "TR4 Sea Fastening", "SEAFAST", "Mammoet", 31, "DUR_SF", ""),
        ("MWS-129A", "5.25", "MWS + MPI + Final Check", "BUFFER", "Aries/Captain", 31, "DUR_MWS", ""),
        ("SAIL-130", "5.3", "V4 Sail-away: MZP→AGI", "SAIL", "LCT Bushra", 31, "DUR_SAIL", ""),
        ("ARR-131", "5.4", "AGI Arrival + TR4 RORO Unload", "AGI_UNLOAD", "Mammoet", 32, "DUR_UL", ""),
        ("TRN-132", "5.5", "TR3 Transport to Bay-3", "TURNING", "Mammoet", 33, 1, ""),
        ("TURN-133", "5.6", "TR3 Turning (90° rotation)", "TURNING", "Mammoet", 34, "DUR_TURN", ""),
        ("TRN-135", "5.8", "TR4 Transport to Bay-4", "TURNING", "Mammoet", 38, 1, ""),
        ("TURN-136", "5.9", "TR4 Turning (90° rotation)", "TURNING", "Mammoet", 39, "DUR_TURN", ""),
        ("JD-139", "5.95", "★ JD-2 Jack-Down Batch (TR3+TR4)", "JACKDOWN", "Mammoet", 42, "DUR_JD", "MILESTONE: TR3+TR4 Complete (Batch)"),
        ("RET-138", "5.11", "V4 LCT Return: AGI→MZP", "RETURN", "LCT Bushra", 43, "DUR_RET", "Return after JD-2"),
        ("BUF-140", "5.99", "V4 Buffer", "BUFFER", "All", 44, "DUR_BUF", ""),
        
        # Voyage 5
        ("V5", "6.0", "VOYAGE 5: TR5 Transport", "MILESTONE", "All", 46, 0, ""),
        ("LO-140", "6.1", "TR5 Load-out on LCT", "LOADOUT", "Mammoet", 46, "DUR_LO", ""),
        ("SF-141", "6.2", "TR5 Sea Fastening", "SEAFAST", "Mammoet", 47, "DUR_SF", ""),
        ("MWS-141A", "6.25", "MWS + MPI + Final Check", "BUFFER", "Aries/Captain", 47, "DUR_MWS", ""),
        ("SAIL-142", "6.3", "V5 Sail-away: MZP→AGI", "SAIL", "LCT Bushra", 47, "DUR_SAIL", ""),
        ("ARR-143", "6.4", "AGI Arrival + TR5 RORO Unload", "AGI_UNLOAD", "Mammoet", 48, "DUR_UL", ""),
        ("STORE-144", "6.5", "TR5 Stored on AGI Laydown", "BUFFER", "Mammoet", 49, "DUR_BUF", "Awaiting pair TR6"),
        ("RET-145", "6.6", "V5 LCT Return: AGI→MZP", "RETURN", "LCT Bushra", 50, "DUR_RET", ""),
        ("BUF-146", "6.99", "V5 Buffer", "BUFFER", "All", 51, "DUR_BUF", ""),
        
        # Voyage 6 + Jack-down 3 (Batch)
        ("V6", "7.0", "VOYAGE 6: TR6 Transport + JD-3", "MILESTONE", "All", 52, 0, ""),
        ("LO-147", "7.1", "TR6 Load-out on LCT", "LOADOUT", "Mammoet", 52, "DUR_LO", ""),
        ("SF-148", "7.2", "TR6 Sea Fastening", "SEAFAST", "Mammoet", 53, "DUR_SF", ""),
        ("MWS-148A", "7.25", "MWS + MPI + Final Check", "BUFFER", "Aries/Captain", 53, "DUR_MWS", ""),
        ("SAIL-149", "7.3", "V6 Sail-away: MZP→AGI", "SAIL", "LCT Bushra", 53, "DUR_SAIL", ""),
        ("ARR-150", "7.4", "AGI Arrival + TR6 RORO Unload", "AGI_UNLOAD", "Mammoet", 54, "DUR_UL", ""),
        ("TRN-151", "7.5", "TR5 Transport to Bay-5", "TURNING", "Mammoet", 55, 1, ""),
        ("TURN-152", "7.6", "TR5 Turning (90° rotation)", "TURNING", "Mammoet", 56, "DUR_TURN", ""),
        ("TRN-154", "7.8", "TR6 Transport to Bay-6", "TURNING", "Mammoet", 60, 1, ""),
        ("TURN-155", "7.9", "TR6 Turning (90° rotation)", "TURNING", "Mammoet", 61, "DUR_TURN", ""),
        ("JD-157", "7.95", "★ JD-3 Jack-Down Batch (TR5+TR6)", "JACKDOWN", "Mammoet", 64, "DUR_JD", "MILESTONE: TR5+TR6 Complete (Batch)"),
        ("RET-158", "7.11", "V6 LCT Return: AGI→MZP", "RETURN", "LCT Bushra", 65, "DUR_RET", "Return after JD-3"),
        ("BUF-159", "7.99", "V6 Buffer / Reset for V7", "BUFFER", "All", 66, "DUR_BUF", ""),
        
        # Voyage 7 + Jack-down 4
        ("V7", "8.0", "VOYAGE 7: TR7 Transport + JD-4", "MILESTONE", "All", 67, 0, "Final unit"),
        ("LO-201", "8.1", "TR7 Load-out on LCT", "LOADOUT", "Mammoet", 67, "DUR_LO", "High tide required"),
        ("SF-202", "8.2", "TR7 Sea Fastening", "SEAFAST", "Mammoet", 68, "DUR_SF", "12-point lashing"),
        ("MWS-202A", "8.25", "MWS + MPI + Final Check", "BUFFER", "Aries/Captain", 68, "DUR_MWS", ""),
        ("SAIL-203", "8.3", "V7 Sail-away: MZP→AGI", "SAIL", "LCT Bushra", 69, "DUR_SAIL", "Weather window required"),
        ("ARR-204", "8.4", "AGI Arrival + TR7 RORO Unload", "AGI_UNLOAD", "Mammoet", 70, "DUR_UL", "AGI FWD Draft ≤ 2.70m"),
        ("TRN-205", "8.5", "TR7 Transport to Bay-7", "TURNING", "Mammoet", 71, 1, "Steel bridge install"),
        ("TURN-206", "8.6", "TR7 Turning (90° rotation)", "TURNING", "Mammoet", 72, "DUR_TURN", "10t Forklift required"),
        ("JD-207", "8.7", "★ JD-4 Jack-Down (TR7)", "JACKDOWN", "Mammoet", 76, "DUR_JD", "MILESTONE: TR7 Complete"),
        ("RET-208", "8.8", "V7 LCT Final Return: AGI→MZP", "RETURN", "LCT Bushra", 77, "DUR_RET", "Final return"),
        
        # Demobilization
        ("DEMOB", "9.0", "DEMOBILIZATION", "MOBILIZATION", "Mammoet", 78, "DUR_MOB", "Equipment return"),
        ("END", "99.0", "★★★ PROJECT COMPLETE ★★★", "MILESTONE", "All", 79, 0, "All 7 TRs Installed"),
    ]
    ...
    ws_gantt["A2"] = "Orange Zone = Winter Shamal Risk Period (Jan 14-21) | VBA: RefreshGanttChart로 색상 갱신"
    ...
    # Date columns (79 days from project start to cover all tasks)
    date_col = 8
    for i in range(79):
    ...
    weather_data = [
        ("Avg Wind (kt)", "11-13", "16-21", "13-15", "12-14", "Peak Shamal: Jan 14-21"),
    ...
    summary_data = [
        ...
        ("Voyage 1 (TR1)", "Day 3-8"),
        ("Voyage 2 (TR2+JD)", "Day 9-23"),
        ("Voyage 3 (TR3)", "Day 24-29"),
        ("Voyage 4 (TR4+JD)", "Day 30-44"),
        ("Voyage 5 (TR5)", "Day 46-51"),
        ("Voyage 6 (TR6+JD)", "Day 52-66"),
        ("Voyage 7 (TR7+JD)", "Day 67-77"),
        ("Project Complete", "=MAX(Schedule_Data!G:G)"),
        ("", ""),
        ("Weather Constraints", ""),
        ("Shamal Period", "Jan 14-21, 2026"),
...
Sub RefreshGanttChart()
    ...
    ws.Range(ws.Cells(5, dc), ws.Cells(85, dc + 78)).Interior.ColorIndex = xlNone
...
Sub CheckShamalRisk()
    ...
    If cnt > 0 Then
        MsgBox "⚠️ SHAMAL 위험 경고!" & vbCrLf & vbCrLf & _
               "Shamal 기간 (Jan 14-21) 중 " & cnt & "개 기상 민감 작업 발견:" & vbCrLf & _
