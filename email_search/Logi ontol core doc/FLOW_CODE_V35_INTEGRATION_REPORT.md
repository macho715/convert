...
| `hvdc:hasSiteArrival` | Datatype | Boolean | 사이트 도착 플래그 (파생값) |
| `hvdc:siteArrivalDate` | Datatype | Date | 사이트 도착 날짜 (Generic) |
| `hvdc:shuArrivalDate` | Datatype | Date | SHU 현장 도착 날짜 |
| `hvdc:mirArrivalDate` | Datatype | Date | MIR 현장 도착 날짜 |
| `hvdc:dasArrivalDate` | Datatype | Date | DAS 현장 도착 날짜 |
| `hvdc:agiArrivalDate` | Datatype | Date | AGI 현장 도착 날짜 |
