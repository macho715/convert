...
# -*- coding: utf-8 -*-
"""
AGI TR MasterSuite Workbook Builder (v3.1.0)
...
Outputs:
  - AGI_TR6_MasterSuite_READY_v3_1.xlsx
  - AGI_TR6_MasterSuite_READY_v3_1.xlsm (macro-enabled container; import .bas in Excel)
...
def main():
    ...
    ap.add_argument("--out", default="AGI_TR6_MasterSuite_READY_v3_1.xlsx", help="Output xlsx filename")
    args = ap.parse_args()
