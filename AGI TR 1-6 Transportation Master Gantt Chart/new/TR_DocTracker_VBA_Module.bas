...
'===============================================================================
Public Sub ApplyStatusFormatting()
    Dim ws As Worksheet
    Dim rng As Range
    Dim cell As Range
...
'===============================================================================
Public Sub CalculatePartyProgress()
    Dim ws As Worksheet
    Dim wsDash As Worksheet
    Dim lastRow As Long
...
'===============================================================================
Public Sub AutoRefreshAll()
    Call ApplyStatusFormatting
    Call CalculateProgress
    Call CalculatePartyProgress
...
'===============================================================================
Public Sub CreateVoyageSummaryReport()
    Dim ws As Worksheet
...
'     Application.OnKey "^+R", "AutoRefreshAll"
'     ' Ctrl+Shift+S = Quick Status Update
'     Application.OnKey "^+S", "QuickStatusUpdate"
'     ' Ctrl+Shift+P = Export to PDF
'     Application.OnKey "^+P", "ExportToPDF"
' End Sub
'
