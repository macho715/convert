...
- `hvdc:hasSiteArrival` - Site arrival flag (derived boolean)
- `hvdc:siteArrivalDate` - Generic site arrival date (subPropertyOf parent)
- `hvdc:shuArrivalDate` - SHU site arrival date (subPropertyOf siteArrivalDate)
- `hvdc:mirArrivalDate` - MIR site arrival date (subPropertyOf siteArrivalDate)
- `hvdc:dasArrivalDate` - DAS site arrival date (subPropertyOf siteArrivalDate)
- `hvdc:agiArrivalDate` - AGI site arrival date (subPropertyOf siteArrivalDate)
